...
The day before you leave, make sure this car charger is full charged and placed
...
![Cleaning stuff](/img/checkout/checkout-kitchen-left-01.png)
...
can all be found under the microwave.  If out, please more of this exact type
at Komeri down the street.  They are super cheap.  Make sure you buy the 45
liter bags that are 0.025mm thick, other ones tear too easily.

![Simple polymer bags](/img/IMG_4012.png)

## Putting things back in place

As you clean up, try to arrange things in as they are in the photos below.  It
doesn't need to be exact but matching this will help everyone put things back
in a somewhat logical and easy to find location.

### Kitchen

![Kitchen Left Side](/img/checkout/checkout-kitchen-left-01.png)

![Kitchen Left Side](/img/checkout/checkout-kitchen-left-02.png)

![Kitchen Left Side](/img/checkout/checkout-kitchen-left-03.png)

![Kitchen Right Side](/img/checkout/checkout-kitchen-right-01.png)

![Kitchen Right Side](/img/checkout/checkout-kitchen-right-02.png)

![Kitchen Right Side](/img/checkout/checkout-kitchen-right-03.png)

![Kitchen Floating Shelves](/img/checkout/checkout-kitchen-shelf.png)

![Kitchen Trash](/img/checkout/checkout-kitchen-trash.png)

### Japanese Room

![Futon Linens](/img/checkout/checkout-washitsu-linens.png)

![Closet](/img/checkout/checkout-washitsu-closet.png)

![Room Arrangment](/img/checkout/checkout-washitsu-room-01.png)

![Room Arrangment](/img/checkout/checkout-washitsu-room-02.png)

### Living Room

![Bookcase Number 1](/img/checkout/checkout-bookcase-01.png)

![Bookcase Number 2](/img/checkout/checkout-bookcase-02.png)

![Corner](/img/checkout/checkout-cleaning-corner.png)

![Couch](/img/checkout/checkout-livingroom.png)

![Media Stand](/img/checkout/checkout-media-stand.png)

![Fireplace](/img/checkout/checkout-fireplace.png)


### Second Floor

![Linens](/img/checkout/checkout-second-floor-linens.png)

![Duvets](/img/checkout/checkout-second-floor-duvet.png)
...
The water heater is pretty intuitive, just hit the off button and then press
the big gray button so that the green light goes off.  This should let the
water drain out and prevent water pipes freezing.
